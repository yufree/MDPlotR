        ...
        output$plotctr <- renderUI({
                if (input$single == "Single") {
                        fluidRow(
                                h4("Plot controls"),
                                tags$br(),
                                textInput('x1', 'x axis label', ''),
                                textInput('y1', 'y axis label', ''),
                                column(
                                        6,
                                        selectInput(
                                                inputId = 'xvar1',
                        ...
                        fluidRow(
                                h4("Plot controls"),
                                tags$br(),
                                textInput('x1', 'x axis label for plot 1', ''),
                                textInput('y1', 'y axis label for plot 1', ''),
                                textInput('x2', 'x axis label for plot 2', ''),
                                textInput('y2', 'y axis label for plot 2', ''),
                                column(
                                        6,
                                        selectInput(
                                                inputId = 'xvar1',
